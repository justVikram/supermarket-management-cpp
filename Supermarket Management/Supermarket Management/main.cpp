    ...
    int main(int argc, const char *argv[])
    {
        ...
        list_of_suppliers.push_backs(supplier("jai trading company"));
        ...
        list_of_suppliers.push_back(supplier("snacksLTD"));
            ...
            list_of_assistants.push_back(assistant("unbelievable rates today!","vishal",798883721,"stationroad",3846362621,11000,jd5));
