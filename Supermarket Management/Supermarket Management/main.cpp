    ...
    int main(int argc, const char *argv[])
    {
        ...
        list_of_cashiers.push_back(cashier(5,"amal",8383839291,"vidyanagar",473838282,10000,jd1));
        ...
        list_of_cashiers.push_back(cashier(2,"akansha",928338111,"gokulroad",5768554939,12000,jd5));
